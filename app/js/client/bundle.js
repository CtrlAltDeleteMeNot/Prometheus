...
(() => {
  ...
  var _root6, _footer4, SignalSectionView;
  ...
  var _mainView, _mainModel, _worker, _promises, _id2, _eventHandlers, _ThinController, ThinController;
  var init_ThinController = __esm({
    "ts_libs/ts_client/controllers/ThinController.ts"() {
      ...
      _ThinController = class _ThinController {
        ...
        fetch() {
          return __async(this, null, function* () {
            const settings = __privateGet(this, _mainModel).getScreenerSettings();
            ...
            const response = yield this.callWorker("fetch", settings.toJson());
        ...
        callWorker(method, args) {
          const id = ++__privateWrapper(this, _id2)._;
